...
class Index extends React.Component {
    ...
    getCode = () => {
        Axios.get('/api/verification/code2?w=120&h=32').then(ret => {
        ...
        return (
          <div className={css.bg}>
            <div className={css.box}>
              <h1 className={css.title}>JOIN US</h1>
              <Form onSubmit={this.handleSubmit}>
                ...
                <FormItem>
                  {getFieldDecorator('rspassword', {
                    rules: [{ required: true, message: 'Please enter the password again!' }]
                  })(
                    <Input
                ...
                <FormItem>
                  {getFieldDecorator('remember', {
                    ...
                    <Checkbox>
                      Agree
                      <a onClick={this.agreement.bind(this, true)} href="javascript:">
                        &nbsp;Teaty
                      </a>
                    </Checkbox>
                  )}
              ...
              >
                <pre className={css.agreement}>{con}</pre>
              </Modal>
            </div>
          </div>
        )
